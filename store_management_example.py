...
cart1 = ShoppingCart(products[0])  # Bread
...
cart2 = ShoppingCart(products[2])  # Smartphone
...
cart3 = ShoppingCart(products[3])  # Laptop
...
print(f"Cart3 (Lida): {cart3.status}")